...
public class MicroarrayView extends SpecificProjectView{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3980679202914438761L;

	public MicroarrayView() {

		setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Microarray", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
